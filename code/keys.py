...
default_alphabet = "air bat card drum each fine gust ham ivy jane crunch look made near odd pink quench red spa trap urge vest whale plex yank zone".split(
    " "
    #die
    #bat
    #cap
