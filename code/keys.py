...
default_alphabet = 'air bat cap die each fine gust harp sit jury crunch look made near odd pit quench red sun trap urge vest whale plex yank zip'.split(' ')
...
alternate_keys = {
    ...
    'forward delete': 'delete', 'scrap': 'delete',
    'shock': 'enter', 
    'pop': 'left', 'push': 'right', 
    'sky': 'up', 'ground': 'down',
    'goop': 'pageup', 'slide': 'pagedown',
}
